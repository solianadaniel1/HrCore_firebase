...
export default function AddActingPage() {
  const [assignmentDate, setAssignmentDate] = React.useState<Date>();

  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Link href="/activities/acting" passHref>
          <Button variant="outline" size="icon">
            <ArrowLeft className="h-4 w-4" />
          </Button>
        </Link>
        <div>
          <h1 className="text-3xl font-bold">Add New Acting Assignment</h1>
          <p className="text-muted-foreground">
            Fill in the details for the new acting role.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="space-y-2">
              ...
              <Input id="employeeName" placeholder="e.g., Grace Hopper" />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="currentSalary" type="number" />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle>New Acting Information</CardTitle>
          </CardHeader>
          <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="space-y-2">
              <Label htmlFor="employeeId">Employee ID</Label>
              <Input id="employeeId" placeholder="e.g., NIB-00128" />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              <Label htmlFor="actingAllowance">Acting Allowance</Label>
              <Input id="actingAllowance" type="number" />
            </div>
             <div className="space-y-2">
              <Label htmlFor="actingType">Acting Type</Label>
              <Select>
                <SelectTrigger id="actingType">
                  <SelectValue placeholder="Select type" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="temporary-coverage">Temporary Coverage</SelectItem>
                  <SelectItem value="project-based">Project-based</SelectItem>
                  <SelectItem value="higher-duties">Higher Duties</SelectItem>
                </SelectContent>
              </Select>
            </div>
             <div className="space-y-2">
